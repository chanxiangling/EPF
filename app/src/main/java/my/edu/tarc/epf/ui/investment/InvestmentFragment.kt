...
class InvestmentFragment : Fragment() {
    ...
    var _binding:FragmentInvestmentBinding?=null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonDOB.setOnClickListener {
            val dateDialogFragment = DateDiologFragment{
    ...
    private fun onDateSelected(year: Int,month: Int,day: Int){
        binding.buttonDOB.text = String.format("%d/%d/%d",
            day, month+1, year)
        val dob = getInstance()
        with(dob){
            set(YEAR,year)
    ...
    class DateDiologFragment(val dateSetListerner:(year:Int, month:Int, day:Int) -> Unit):DialogFragment(),DatePickerDialog.OnDateSetListener{
        ...
        override fun onDateSet(p0: DatePicker?, year: Int, month: Int, day: Int) {
            dateSetListerner(year,month, day)
        }
